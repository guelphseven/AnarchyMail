...
public class AnarchyMailAnswerNotifier {
	...
	public AnarchyMailAnswerNotifier(Context context) {
		mContext = context;
	...
	private void enableNotification() {
		...
		Intent notificationIntent = new Intent(mContext, AnarchyMailPreferenceActivity.class);
